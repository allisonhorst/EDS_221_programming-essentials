...
-   Create a new version-controlled R Project for Day 5
...
-   In a new R Markdown document, attach the `tidyverse`, `testthat` and `usethis` packages in a code chunk
...
mean_range <- function(df) {
  col_means <- apply(X = df, MARGIN = 2, FUN = mean) # Returns column means as a vector
...
That test fails. Now you have an idea of what little unit tests do.

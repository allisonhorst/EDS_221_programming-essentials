...
## Task 2: Help a friend by making a `reprex`

- Open the `make_a_reprex.Rmd` file
- There are three separate code chunks in the .Rmd. None of them will run.
...
- Then, for each **create a reprex** that provides a minimal out-of-the-box reproducible example of the thing in the code that isn't working. Create your reprex in a separate code chunk below each example. Use `{reprex}` to send your examples to your neighbor on Slack. 
